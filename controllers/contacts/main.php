...
//        $structure['type']['attr']['value']  = $this->type;
        ...
        $data = ['type'=>'divHTML', 'title'=>$title,
            ...
            'tabs'    => ['tabContacts'=>['divs'=>[
                ...
                'prices_c'=> ['order'=>40, 'label'=>sprinft(lang('tbd_prices'), lang('ctype_c')),'hidden'=>!empty($cData['ctype_c'])?false:true,'type'=>'html', 'html'=>'',
                    'options'=>['href'=>"'".BIZUNO_AJAX."&bizRt=inventory/prices/manager&dom=div&type=c&cID=$rID&table=contacts'"]],
                'prices_v'=> ['order'=>40, 'label'=>sprinft(lang('tbd_prices'), lang('ctype_v')),'hidden'=>!empty($cData['ctype_v'])?false:true,'type'=>'html', 'html'=>'',
