 ...
 * @filesource controllers/administrate/dashboards/adm_notice/adm_notice.php
 */
...
class adm_notice
{
    ...
    public $noClose   = true;
    public  $struc;
    public $lang      = ['title' => 'Admin - Notices',
        'description' => 'Notice administration dashboard with summary information and quick links.'];
