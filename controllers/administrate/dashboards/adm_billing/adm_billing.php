<?php
/*
 * Bizuno dashboard - Admin summary for billing
 *
 ...
 * @filesource controllers/administrate/dashboards/adm_billing/adm_billing.php
 */
...
class adm_billing
{
    ...
    public $noClose   = true;
    public  $struc;
    public $lang      = ['title' => 'Admin - Billing',
        'description' => 'Billing administration dashboard with summary information and quick links.'];
