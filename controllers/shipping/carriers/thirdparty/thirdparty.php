...
class thirdparty
{
    ...
    public $lang     = ['title' => 'Third Party Shipping!',
        ...
        'rate'       => 'The packaging/handling cost for all orders using this shipping method.',
        'GND' => 'Third Party'];
    ...
    {
        return ['GND'=>['title'=>$this->lang['GND'],'gl_acct'=>$this->settings['gl_acct'],'book'=>$this->settings['rate'],'quote'=>$this->settings['rate']]];
    }
}
