...
class percent
{
    ...
    public function settingsStructure()
    {
        ...
        return [
            ...
            'percent'  => ['label'=>$this->lang['percent'], 'position'=>'after','attr'=>['type'=>'float', 'size'=>'10', 'value'=>$this->settings['percent']]],
            'minRate'  => ['label'=>$this->lang['min_rate'],'position'=>'after','attr'=>['type'=>'float', 'size'=>'10', 'value'=>'0']],
