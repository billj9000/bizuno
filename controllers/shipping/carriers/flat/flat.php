<?php
/*
 * Shipping extension for flat rated shipments
 *
 ...
 * @filesource /controllers/shipping/carriers/flat/flat.php
 */
...
class flat
{
    ...
    public $confirm_type;
    public $lang     = ['title'=>'Flat Rate',
        'acronym'    => 'Flat',
        'description'=> 'Flat Rate shipping set a single shipping price for an entire order.',
    ...
    {
        $this->settings= ['rate'=>'0','order'=>30,'service_types'=>'GND','default'=>'0',
    ...
    public function settingsStructure()
    {
        ...
        return [
            ...
            'service_types'=> ['label'=>$this->lang['shipping_settings_default_service'], 'position'=>'after', 'values'=>$services,
    ...
    {
        return ['GND'=>['title'=>$this->lang['GND'],'gl_acct'=>$this->settings['gl_acct'],'book'=>$this->settings['rate'],
            'cost'=> '','quote'=>$this->settings['rate'],'note'=>'']];
    }
}
