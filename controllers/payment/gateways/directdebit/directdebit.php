 ...
 * posted reference number (`ref_1`) as the txID; everything else is notImplemented.
 */
...
function payment_".$this->code."() {
    ...
    // No external gateway; capture just records the posted reference number.
    // ========================================================================
    ...
    public function payment($action, $data=[])
    {
        switch ($action) {
            ...
            case 'authorize':
                ...
                return ['ok'=>true, 'txID'=>$ref, 'code'=>'', 'msg'=>'Direct debit recorded', 'data'=>[], 'raw'=>null];
        }
