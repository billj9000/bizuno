...
/*******************************************************************************************************************/
    ...
    public function customizeView(&$data)
    {
        ...
        $data['fields']['invoice_num']['attr']['value'] = getNextReference('next_ref_j20');
        ...
        $data['panels']['billAD'] = ['type'=>'address','label'=>lang('bill_to'),'attr'   =>['id'=>'address_b'],'keys'=>$fldAddr,
            'settings'=>['suffix'=>'_b','search'=>true,'copy'=>true,'update'=>true,'validate'=>true,'fill'=>'both','required'=>true,'store'=>false,'cols'=>false]];
        $data['panels']['shipAD'] = ['type'=>'address','label'=>lang('ship_to'),'attr'   =>['id'=>'address_s'],'keys'=>$fldAddr,
