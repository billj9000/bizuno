...
class shipping
{
    ...
    public function __construct()
    {
        ...
        $glV           = getModuleCache('shipping','settings','general','gl_shipping_v', getModuleCache('phreebooks','settings','vendors',  'gl_expense'));
        $glC           = getModuleCache('shipping','settings','general','gl_shipping_c', getModuleCache('phreebooks','settings','customers','gl_sales'));
    ...
    public function settingsStructure()
    {
        return [
            ...
            'gl_account'=> ['attr'=>['type'=>'hidden','value'=>$this->settings['gl_account']]], // set in shipping settings
    ...
    public function render($data=[])
    {
        ...
        $resi = getModuleCache('shipping', 'settings', 'general', 'resi_checked', 1);
    ...
    {
        // @todo Deprecate the taxShipping setting from shipping, s/b set at PhreeBooks settings
