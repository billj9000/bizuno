...
class open_j13
{
    ...
    public  $struc;
    public  $lang     = ['title'=>'Unpaid Customer Credits',
        'description'=> 'Lists unpaid customer credits (refunds). A link to review each entry in a separate window is also provided. Settings are available for enhanced security and control.'];
    private $journalID= 13;
