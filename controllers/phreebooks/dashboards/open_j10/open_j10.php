...
class open_j10
{
    ...
    public  $struc;
    public  $lang     = ['title'=>'Open Sales Orders',
        'description'=> 'Lists open customer Sales Orders. Links to review the invoice are also provided. Settings are available for enhanced security and control.'];
