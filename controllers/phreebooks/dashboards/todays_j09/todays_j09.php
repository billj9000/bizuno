<?php
/*
 * PhreeBooks dashboard - Today's Customer Requests for Quote
 *
 ...
 * @filesource /controllers/phreebooks/dashboards/todays_j09/todays_j09.php
 */
...
class todays_j09
{
    ...
    public  $code     = 'todays_j09';
    public  $secID    = 'j9_mgr';
    public  $category = 'customers';
    public  $struc;
    public  $lang     = ['title'=>'Today\'s Quotes',
        'description'=> 'Lists todays customer Quotes. A link to review each entry in a separate window is also provided. Settings are available for enhanced security and control.'];
    private $journalID= 9;
