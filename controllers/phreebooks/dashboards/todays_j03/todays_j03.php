 ...
 * @filesource /controllers/phreebooks/dashboards/todays_j03/todays_j03.php
 */
...
class todays_j03
{
    ...
    public  $struc;
    public  $lang     = ['title'=>'Today\'s RFQ\'s',
        'description'=> 'Lists todays vendor Request for Quotes. A link to review each entry in a separate window is also provided. Settings are available for enhanced security and control.'];
    private $journalID= 3;
