...
class currency_oanda
{
    ...
    public  $struc;
    public $lang      = ['title' => 'Oanda Currency Exchange Rates',
        'description' => 'Lists an exchange rate converter using the oanda.com web site as source.',
...
<script src="https://www.oanda.com/embedded/converter/get/b2FuZGFlY2N1c2VyLy9kZWZhdWx0/?lang='.$lang.'"></script></div>';
        $data = [
            'divs'  => ['body'=>['attr'=>['id'=>'oanda_ecc'],'type'=>'divs','divs'=>[
                ...
                'formBOF'=>['order'=>40,'type'=>'form',  'key' =>'oandaForm'],
            ...
            'fields'=> [
                ...
                'btnUpd' => ['order'=>40,'attr'=>['type'=>'button','value'=>lang('update')],'events'=>['onClick'=>"jqBiz('#oandaForm').submit();"]]],
            'forms' => ['oandaForm'=>['attr'=>['type'=>'form','action'=>BIZUNO_URL_AJAX."&bizRt=phreebooks/currency/setExcRate"]]],
