<?php
/*
 * PhreeBooks Dashboard - Open Vendor Requests for Quote
 *
 ...
 * @filesource /controllers/phreebooks/dashboards/open_j03/open_j03.php
 */
...
class open_j03
{
    ...
    public  $code     = 'open_j03';
    public  $secID    = 'j4_mgr';
    public  $category = 'vendors';
    public  $struc;
    public  $lang     = ['title'=>'Open Vendor RFQ\'s',
        'description'=> 'Lists open vendor Request for Quotes. A link to review each entry in a separate window is also provided. Settings are available for enhanced security and control.'];
    private $journalID= 3;
