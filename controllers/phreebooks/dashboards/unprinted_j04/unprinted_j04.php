...
class unprinted_j04
{
    ...
    public  $struc;
    public  $lang     = ['title'=>'Unprinted Purchase Orders',
        'description'=> 'Lists unprinted purchase orders with button to print directly from the dashboard. Monitors the printed flag in the journal main database table which is set when a form is generated with the Set Printed option enabled. Settings are available for enhanced security and control.'];
