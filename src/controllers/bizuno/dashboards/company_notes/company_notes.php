 ...
 * @filesource /controllers/bizuno/dashboards/company_notes/company_notes.php
 */
...
class company_notes
{
    ...
    private $metaPrefix= 'company_notes';
    public  $struc;
    public  $lang      = ['title'=>'Company Notes',
        'description'=> 'Allows posting notes and reminders viewable to all in company. Permissions are set based on the Profile settings for the role.'];
