<?php
/*
 * Bizuno dashboard - Admin summary for employees
 *
 ...
 * @filesource controllers/administrate/dashboards/adm_employee/adm_employee.php
 */
...
class adm_employee
{
    ...
    public $noClose   = true;
    public  $struc;
   public $lang      = ['title' => 'Admin - Employees',
        'description' => 'Employee administration dashboard with summary information and quick links.'];
