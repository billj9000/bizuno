...
class todays_j06
{
    ...
    {
        global $currencies;
        $filter= "journal_id IN (6,7) AND post_date='".biz_date('Y-m-d')."'";
        ...
        $result= dbGetMulti(BIZUNO_DB_PREFIX.'journal_main', $filter, $order, ['id','journal_id','total_amount','currency','currency_rate','post_date','waiting','invoice_num', 'primary_name_b'], $opts['num_rows']);
        $total = 0;
