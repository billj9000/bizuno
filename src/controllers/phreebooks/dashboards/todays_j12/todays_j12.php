...
class todays_j12
{
    ...
    public  $struc;
    public  $lang     = ['title'=>'Today\'s Invoices',
        'description'=> 'Lists todays customer Sales/Invoices. A link to review each entry in a separate window is also provided. Settings are available for enhanced security and control.'];
