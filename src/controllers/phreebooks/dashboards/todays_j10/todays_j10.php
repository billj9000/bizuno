 ...
 * @filesource /controllers/phreebooks/dashboards/todays_j10/todays_j10.php
 */
...
class todays_j10
{
    ...
    public  $struc;
    public  $lang     = ['title'=>'Today\'s Sales Orders',
        'description'=> 'Lists todays customer Sales Orders. A link to review each entry in a separate window is also provided. Settings are available for enhanced security and control.'];
    private $journalID= 10;
